    ...
    <Disclosure as="nav">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button
                  type="button"
                  className="relative rounded-full  p-1 text-black hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray"
                >
                ...
                <Button className='bg-pink' onClick={openDrawer}>Open Drawer</Button>
            ...
            <div className="space-y-1 px-2 pb-3 pt-2">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? 'bg-pink text-white' : 'text-black hover:bg-green-50 hover:text-white',
          ...
          {
            isOpen && (
              <Cart openDrawer={openDrawer} open={isOpen}  closeDrawer={closeDrawer} />
            )
          }
